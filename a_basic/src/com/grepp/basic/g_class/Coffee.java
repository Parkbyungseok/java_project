...
// class의 member
// member :
//          class 변수(static) 변수 , class (static) method
//              class 에 속하는 변수, 메서드
//              class의 모든 인스턴스가 공유하는 변수
...
// 동적메모리할당방식은 사용하는 메모리 공간 : stack 영역 , heap 영역
...
public class Coffee {
    ...
    //final을 붙여서 수정할 수 없게
    //상수 : 언제나 같은 값 ex) PI
    //자바에서는 상수를 선언할 때 static final로 사용
    static final String APP_KEY = "A12345474";


    // NOTE G02 생성자
    //생성자 : 사용자 정의 타입을 heap 영역 메모리에 할당할 때, 인스턴스변수를 초기화 하기 위해 사용하는 메서드

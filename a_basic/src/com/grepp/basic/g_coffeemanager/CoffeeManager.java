...
public class CoffeeManager {
    ...
    private static void app() {
        ...
        Coffee[] coffees ={americano, mocha, latte, jetty};
        ...
        while (true) {
            ...
            if (menu == 1) {
                ...
                int code = sc.nextInt(); //상품 코드
                System.out.print("판매량: ");
                int orderCnt = sc.nextInt(); //판매량
                ...
                if (orderCnt <= coffee.stock) {
                    ...
                    if (purchasePrice <= balance) {
                        System.out.println(" system: 주문를 취소합니다.");
                        continue;
                    }
                    // 매입 + 판매
                    System.out.println(
                ...
                if (coffee.stock <= coffee.safetyStock) {
                    // 매입금액 산정
                    int purchasePrice = coffee.stock * 2 * coffee.cost;

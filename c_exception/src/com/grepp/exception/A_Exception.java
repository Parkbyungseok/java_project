...
// 예외 : 예측 가능하고 대응이 가능한 문제, 사전에 예방(예외처리)
...
//Checked Exception : 코드로 예외처리가 불가능한 경우, 예외처리 강제하는 Exception
//UnChecked Exception : 코드로 예외처리가 가능한 경우, 예외처리 강제하지 않는 Exception
public class A_Exception {
    ...
    public void throwMalformedURLEx() throws MalformedURLException {
    ...
    public void throwTimeOutEx() throws TimeOutException {
        ...
        // 만약 지연시간이 3초 이상이면, 더 이상 기다릴 수 없다.

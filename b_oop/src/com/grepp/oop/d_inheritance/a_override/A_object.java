...
// 자바의 모든 클래스는 Object 클래스를 상속 받고 있다.
// 상속 관계 : is-a 관계
...
public class A_object {
    ...
    // @override : 메서드는 부모클래스부터 상속받은 메서드를 override 한 메서드임을 컴파일러에게 전달
    ...
    // 해시함수의 규칙
    // 1. 같은 값을 넣으면 언제나 같은 해시값을 반환
    // 2. 다른 값을 넣으면 언제나 다른 해시값을 반환
